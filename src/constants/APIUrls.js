const API_URLS = {
  GET_WORDS: (group, page, wordsPerExampleSentenceLTE, wordsPerPage) => `https://afternoon-falls-25894.herokuapp.com/words?group=${group}&page=${page}&wordsPerExampleSentenceLTE=${wordsPerExampleSentenceLTE}&wordsPerPage=${wordsPerPage}`,
  ...
  USER_WORDS_BY_USER_ID_WORD_ID: (id, wordId) => `https://afternoon-falls-25894.herokuapp.com/users/${id}/words/${wordId}`,
  USER_AGGREGATED_WORDS_BY_USER_ID: (id, group) => `https://afternoon-falls-25894.herokuapp.com/users/${id}/aggregatedWords?group=${group}&wordsPerPage=600`,
  USER_AGGREGATED_WORDS_BY_USER_ID_WORD_ID: (id, wordId) => `https://afternoon-falls-25894.herokuapp.com/users/${id}/aggregatedWords${wordId}`,
